...
export default function ProductDetailScreen() {
  ...
  const addToCart = async () => {
    ...
    try {
      ...
      Alert.alert("Success", "Product added to cart", [
        ...
        { 
          text: "View Cart", 
          onPress: () => router.push("/(users)/(tabs)/cart") 
        }
      ]);
    } catch (error: any) {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Image
        source={{
          uri: `${API_URL.replace(/\/api\/?$/, "")}${product.image?.startsWith('/') ? '' : '/'}${product.image}`,
        }}
      ...
      <View style={styles.productInfo}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.quantityContainer}>
            ...
            >
              <Ionicons name="add" size={20} color={quantity >= product.stock_quantity ? "#ccc" : "#666"} />
            </TouchableOpacity>
          </View>
